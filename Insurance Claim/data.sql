...
('Auto','Insurance coverge for automobile'),
('Home','Insurance coverge for residential home'),
('Life','Long-term insurance coverge upon the policyholder''s death'),
('Health','Insurance coverge for medical and surgical expenses')
...
(1,3,'2021-03-01','2022-03-01','300.00'),
